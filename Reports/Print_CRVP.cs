...
{
    public partial class Print_CRVP : Form
    {
        ReportParameterCollection parrams;
        public Print_CRVP(ReportParameterCollection paramss)
        {
            InitializeComponent();
            //-------------------
            parrams = paramss;
        ...
        private void load_report()
        {
            ...
            if (radioButton3.Checked) // 1 ->>> A5
            {
                ...
                reportViewer1.LocalReport.ReportEmbeddedResource = "ALBAITAR_Softvet.Reports.CRVP_1_in_A5.rdlc";
            }
            else if (radioButton2.Checked)// 2 ->>> A4
            {
                pg_set.PaperSize = new System.Drawing.Printing.PaperSize("A4", 827, 1170);
                pg_set.Landscape = true;
                reportViewer1.LocalReport.ReportEmbeddedResource = "ALBAITAR_Softvet.Reports.CRVP_2_in_A4.rdlc";
            }
            else // 1 ->>> A4
            {
                pg_set.PaperSize = new System.Drawing.Printing.PaperSize("A4", 827, 1170);
                pg_set.Landscape = true;
                reportViewer1.LocalReport.ReportEmbeddedResource = "ALBAITAR_Softvet.Reports.CRVP_1_in_A4.rdlc";
            }
