                ...
                if (ready)
                {
                    ...
                    {   
                        PreConnection.Excut_Cmd("INSERT INTO `tb_labo_immunologie`"
                                              ...
                                              + "'" + (dataGridView1.Rows[0].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[0].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[1].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[1].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[2].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[2].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[3].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[3].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[4].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[4].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[5].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[5].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[6].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[6].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[7].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[7].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[8].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[8].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[9].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[9].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[10].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[10].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[11].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[11].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[12].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[12].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[13].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[13].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[14].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[14].Cells["MALAD_NME"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[0].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[0].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[1].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[1].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[2].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[2].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[3].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[3].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[4].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[4].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[5].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[5].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[6].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[6].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[7].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[7].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[8].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[8].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[9].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[9].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[10].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[10].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[11].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[11].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[12].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[12].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[13].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[13].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[14].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[14].Cells["METHODE"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[0].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[0].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[1].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[1].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[2].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[2].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[3].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[3].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[4].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[4].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[5].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[5].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[6].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[6].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[7].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[7].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[8].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[8].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[9].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[9].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[10].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[10].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[11].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[11].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[12].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[12].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[13].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[13].Cells["VALUE2"].Value : "") + "',"
                                              + "'" + (dataGridView1.Rows[14].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[14].Cells["VALUE2"].Value : "") + "');");
                    }
                    else
                    {
                        PreConnection.Excut_Cmd("UPDATE `tb_labo_immunologie`"
                                              ...
                                              + "`MALAD_NME_001` = '" + (dataGridView1.Rows[0].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[0].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_002` = '" + (dataGridView1.Rows[1].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[1].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_003` = '" + (dataGridView1.Rows[2].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[2].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_004` = '" + (dataGridView1.Rows[3].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[3].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_005` = '" + (dataGridView1.Rows[4].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[4].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_006` = '" + (dataGridView1.Rows[5].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[5].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_007` = '" + (dataGridView1.Rows[6].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[6].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_008` = '" + (dataGridView1.Rows[7].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[7].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_009` = '" + (dataGridView1.Rows[8].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[8].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_010` = '" + (dataGridView1.Rows[9].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[9].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_011` = '" + (dataGridView1.Rows[10].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[10].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_012` = '" + (dataGridView1.Rows[11].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[11].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_013` = '" + (dataGridView1.Rows[12].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[12].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_014` = '" + (dataGridView1.Rows[13].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[13].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`MALAD_NME_015` = '" + (dataGridView1.Rows[14].Cells["MALAD_NME"].Value != DBNull.Value ? dataGridView1.Rows[14].Cells["MALAD_NME"].Value : "") + "',"
                                              + "`METHODE_001` = '" + (dataGridView1.Rows[0].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[0].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_002` = '" + (dataGridView1.Rows[1].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[1].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_003` = '" + (dataGridView1.Rows[2].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[2].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_004` = '" + (dataGridView1.Rows[3].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[3].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_005` = '" + (dataGridView1.Rows[4].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[4].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_006` = '" + (dataGridView1.Rows[5].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[5].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_007` = '" + (dataGridView1.Rows[6].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[6].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_008` = '" + (dataGridView1.Rows[7].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[7].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_009` = '" + (dataGridView1.Rows[8].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[8].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_010` = '" + (dataGridView1.Rows[9].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[9].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_011` = '" + (dataGridView1.Rows[10].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[10].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_012` = '" + (dataGridView1.Rows[11].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[11].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_013` = '" + (dataGridView1.Rows[12].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[12].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_014` = '" + (dataGridView1.Rows[13].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[13].Cells["METHODE"].Value : "") + "',"
                                              + "`METHODE_015` = '" + (dataGridView1.Rows[14].Cells["METHODE"].Value != DBNull.Value ? dataGridView1.Rows[14].Cells["METHODE"].Value : "") + "',"
                                              + "`MALAD_RESULT_001` = '" + (dataGridView1.Rows[0].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[0].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_002` = '" + (dataGridView1.Rows[1].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[1].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_003` = '" + (dataGridView1.Rows[2].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[2].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_004` = '" + (dataGridView1.Rows[3].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[3].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_005` = '" + (dataGridView1.Rows[4].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[4].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_006` = '" + (dataGridView1.Rows[5].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[5].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_007` = '" + (dataGridView1.Rows[6].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[6].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_008` = '" + (dataGridView1.Rows[7].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[7].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_009` = '" + (dataGridView1.Rows[8].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[8].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_010` = '" + (dataGridView1.Rows[9].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[9].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_011` = '" + (dataGridView1.Rows[10].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[10].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_012` = '" + (dataGridView1.Rows[11].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[11].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_013` = '" + (dataGridView1.Rows[12].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[12].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_014` = '" + (dataGridView1.Rows[13].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[13].Cells["VALUE2"].Value : "") + "',"
                                              + "`MALAD_RESULT_015` = '" + (dataGridView1.Rows[14].Cells["VALUE2"].Value != DBNull.Value ? dataGridView1.Rows[14].Cells["VALUE2"].Value : "") + "'"
